...
if LOAD_ON == False:
    model = mujoco.MjModel.from_xml_path(
        "/home/zihaoye/projects-mujoco/quadruped_load_adaption-master/unitree_mujoco_test/data/a1/xml/a1.xml"
    )
else:
    model = mujoco.MjModel.from_xml_path(
        "/home/zihaoye/projects-mujoco/quadruped_load_adaption-master/unitree_mujoco_test/data/a1/xml/a1_with_load.xml"
    )
...
policy_model = torch.jit.load(
    "/home/zihaoye/projects-mujoco/quadruped_load_adaption-master/unitree_mujoco_test/policy/policy_1.pt"
)
...
actions_scale = 0.25  # 缩放来自策略网络或控制器的输出动作
