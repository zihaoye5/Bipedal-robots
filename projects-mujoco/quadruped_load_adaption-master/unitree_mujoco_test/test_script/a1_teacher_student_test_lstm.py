...
# policy_model_student = torch.jit.load('/home/chang/robotics/rl_learning/rl_legged_adaption/legged_gym/student_training/model/student_policy_epoch_500_0.pt') # 能走的版本
policy_model_student = torch.jit.load('/home/chang/robotics/rl_learning/rl_legged_adaption/legged_gym/student_training/model/student_policy_best3.pt') 
device = torch.device("cuda")
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running() and time.time() - start < 5000:
        ...
        # student_obs_lstm_mlp = np.concatenate([student_obs_t, student_obs_t_1, student_obs_t_2, student_obs_t_3, student_obs_t_4])
        student_obs_lstm_mlp = np.concatenate([student_obs_t_6, student_obs_t_5, student_obs_t_4, student_obs_t_3, student_obs_t_2, student_obs_t_1, student_obs_t])
        observation_student = student_obs_lstm_mlp # 为了兼容原来的代码，将observation_student赋值为student_obs_lstm_mlp
